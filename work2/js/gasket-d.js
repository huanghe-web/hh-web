...
function triangle(a, b, c, theta){
	...
	// a[0] = a[0] * Math.cos(theta) - a[1] * Math.sin(theta);
	// a[1] = a[0] * Math.sin(theta) + a[1] * Math.cos(theta);
	// b[0] = b[0] * Math.cos(theta) - b[1] * Math.sin(theta);
	// b[1] = b[0] * Math.sin(theta) + b[1] * Math.cos(theta);
	// c[0] = c[0] * Math.cos(theta) - c[1] * Math.sin(theta);
	// c[1] = c[0] * Math.sin(theta) + c[1] * Math.cos(theta); 
